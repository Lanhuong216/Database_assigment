...
import styles from '../styles/orderListSale.module.scss';
import { useNavigate } from "react-router-dom";
function orderListSale() {
            ...
            <div className={Order}>
                <div className={head-group}>
                    ...
                    <div className={head-group2}>
                        <label for="fix"><button className={fix}>Bán tại cửa hàng</button></label>
                    </div>
                </div>
                <hr></hr>
                ...
                <div className={charge}>
                    ...
                    <label>Nhân viên xuất đơn: Thu Thủy</label>
                </div>
            </div>
        </div>
