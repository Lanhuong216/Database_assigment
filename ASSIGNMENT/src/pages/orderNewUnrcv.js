...
import styles from '../styles/orderNewUnrcv.module.scss';
import { useNavigate } from "react-router-dom";
function orderNewUnrcv() {
    ...
    return (
            ...
            <div className={Order}>
                <div className={head-group}>
                    ...
                    <div className={head-group2}>
                        <label for="fix"><button className={fix}>Chưa nhận</button></label>
                    </div>
                </div>
                <hr></hr>
        ...
        <div className={back}><button className={button}>Nhận đơn</button></div>
    </div>
        </>
    )
}
s default orderNewUnrcv;