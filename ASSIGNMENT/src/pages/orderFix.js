...
import styles from '../styles/orderFix.module.scss';
            ...
            <div className={Order}>
                <div className={head-group}>
                    ...
                    <div className={head-group2}>
                        <label for="fix"><button className={fix}>Hàng lỗi</button></label>
                    </div>
                </div>
                <hr></hr>
            ...
            <div className={form-group3}>
                ...
                <div className={rate}>
                    ...
                    <div className={Report}>
                        ...
                        <label> Ăn ngay nói thật, mọi tật mọi lành</label>
                        <label> Đói cho sạch, rách cho thơm.</label>
                        <label> Ăn một miếng, tiếng để đời.</label>
                </div>
            </div>
        </div>
