...
import styles from '../styles/orderListReceived.module.scss';
import { useNavigate } from "react-router-dom";
function orderListReceived() {
    ...
    return (
            ...
            <div className={Order}>
                <div className={head-group}>
                    ...
                    <div className={head-group2}>
                        <label for="fix"><button className={fix}>Đã nhận</button></label>
                    </div>
                </div>
                <hr></hr>
        ...
        <div className={back}><button className={button}>Xuất đơn</button></div>
    </div>
        </>
    )
}
s default orderListReceived;